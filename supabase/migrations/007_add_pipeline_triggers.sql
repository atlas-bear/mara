-- Migration to add database triggers for the data processing pipeline
-- Connects raw data collection to processing and incident updates to flash reports
...
declare
    ...
    trigger_info text;
begin
    -- Check for existing raw data trigger
    select exists (
        ...
        and t.tgname = 'tg_raw_data_process'
    ...
    trigger_info := case
        ...
        when raw_data_trigger_exists then
            'Raw data trigger already exists'
